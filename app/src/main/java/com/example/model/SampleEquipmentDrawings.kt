...
object SampleEquipmentDrawings {
    ...
    fun getMbbrStpTankProject(): CadProject {
        ...
        // Settling Tank Hopper cone lines
        ...
        // Outlet Nozzle on settling tank right
    ...
    fun getSsCycloneHopperProject(): CadProject {
        ...
        entities.add(CadCircle(cx = topCx, cy = topCy, radius = 210f, isPcd = true, layerId = "CENTER"))
        ...
        entities.add(CadRect(x = fCx - 40f, y = fTopY - 60f, width = 80f, height = 15f, layerId = "NOZZLE"))
        entities.add(CadRect(x = fCx - 25f, y = fTopY - 45f, width = 50f, height = 45f, layerId = "NOZZLE"))
        ...
        entities.add(CadLine(x1 = fCx - fShellW * 0.5f - 65f, y1 = brkY + 16f, x2 = fCx - fShellW * 0.5f, y2 = brkY + 60f))

        entities.add(CadRect(x = fCx + fShellW * 0.5f, y = brkY, width = 65f, height = 16f, layerId = "0"))
        entities.add(CadLine(x1 = fCx + fShellW * 0.5f + 65f, y1 = brkY + 16f, x2 = fCx + fShellW * 0.5f, y2 = brkY + 60f))

        // Elevation Dimensions (Left chain: 60, 250, 200, 60, 570)
    ...
    fun getSsMobileTrayRackProject(): CadProject {
        ...
        entities.add(CadRect(x = rX + rW * 0.5f - 15f, y = rY, width = 30f, height = rH, layerId = "0"))
        ...
        for (i in 0 until numTiers) {
            ...
            entities.add(CadLine(x1 = rX + 30f, y1 = tierY, x2 = rX + 45f, y2 = tierY - 12f, layerId = "0"))

            entities.add(CadLine(x1 = rX + rW * 0.5f + 15f, y1 = tierY, x2 = rX + rW - 30f, y2 = tierY, layerId = "0"))
            entities.add(CadLine(x1 = rX + rW * 0.5f + 15f, y1 = tierY, x2 = rX + rW * 0.5f + 30f, y2 = tierY - 12f, layerId = "0"))
        }
        ...
        entities.add(CadRect(x = rX + 10f, y = wheelY, width = 30f, height = 15f, layerId = "0"))
        ...
        entities.add(CadRect(x = rX + rW - 60f, y = wheelY, width = 30f, height = 15f, layerId = "0"))
    ...
    fun getSsDoubleSinkProject(): CadProject {
        ...
        entities.add(CadRect(x = sX - 20f, y = sY - 80f, width = sW + 40f, height = 80f, layerId = "0"))
        entities.add(CadLine(x1 = sX - 20f, y1 = sY, x2 = sX + sW + 20f, y2 = sY))
        entities.add(CadRect(x = sX - 25f, y = sY, width = sW + 50f, height = 40f, layerId = "0"))
        ...
        entities.add(CadCircle(cx = bowl1X + bowlW * 0.5f, cy = bowlY + bowlH * 0.5f, radius = 22f, layerId = "NOZZLE"))
